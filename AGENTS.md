...
> For client-side instructions, see the `Agents.md` in the `zee6do-client` repository.
...
- **Client**: [zee6do-client](https://github.com/DeepakDP5/zee6do-client) — Expo React Native mobile app (iOS + Android).
